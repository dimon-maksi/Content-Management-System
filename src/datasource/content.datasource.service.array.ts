...
@Injectable()
export class ArrayArticleDatasourceService
	implements IBaseContentDatasourceService<Article>
{
...
@Injectable()
export class ArrayProductDatasourceService
	implements IBaseContentDatasourceService<Product>
{
